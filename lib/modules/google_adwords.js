...
var google_adwords = module.exports =
oauthModule.submodule('google_adwords')
  .configurable({
  ...
  .entryPath('/auth/google_adwords')
  .callbackPath('/auth/google_adwords/callback')
 ...
 * @param {Function} cb
 */
google_adwords.refreshToken = function (params, cb) {
