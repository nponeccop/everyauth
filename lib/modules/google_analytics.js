...
module.exports = oauthModule.submodule('google_analytics')
  .configurable({
      scope: 'URL identifying the Google service to be accessed. See the documentation for the API you like to use for what scope to specify. To specify more than one scope, list each one separated with a space.'
  })
  ...
  .entryPath('/auth/google_analytics')
  .callbackPath('/auth/google_analytics/callback')
  ...
  .moduleErrback( function (err, seqValues) {
    ...
    if (err instanceof Error) {
      ...
      googleResponse = err.extra.res;
      serverResponse = seqValues.res;
      serverResponse.writeHead(googleResponse.statusCode, googleResponse.headers);
